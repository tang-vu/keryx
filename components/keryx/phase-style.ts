...
export const PHASE_STYLES: Record<TracePhase, PhaseStyle> = {
  ...
  evidence: { label: "Evidence", chip: PAID, dot: "bg-paid", icon: FileCheck2 },
  adjudicate: { label: "Adjudicate", chip: SEAL, dot: "bg-seal", icon: Gavel },
  verdict: { label: "Verdict", chip: NEUTRAL, dot: "bg-ink-3", icon: Gauge },
