...
> **STATUS (2026-07-04) — LIVE.** Deployed at **[keryx.cc](https://keryx.cc)** (VPS + Cloudflare Tunnel),
> funded, settling **real** x402 nanopayments on Arc testnet (`KERYX_FORCE_OFFLINE=0`): 3,070+ settled
> payments, ~$15.0 USDC to 20 creators, 663 autonomous queries. The phase log below is the build history;
