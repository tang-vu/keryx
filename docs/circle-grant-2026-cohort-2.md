...
Tang Vu — Founder and Lead Engineer. Vu is the solo technical lead responsible for Keryx's
product, architecture, smart contracts, Circle Gateway integration, security model, deployment,
and creator/agent developer experience. Since launching Keryx, Vu has shipped the system from an
