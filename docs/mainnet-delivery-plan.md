...
| --- | --- | --- | --- |
| B1 | Buyer discovers an offer, understands price/quality limits, funds a wallet, buys and follows a research job | `/research`, `lib/buyer/`, package/pricing modules; saved owner-operated pilots | Complete browser purchase/recovery without requiring a shell. Validate cap, payee, insufficient balance, wallet rejection, response loss and reload. Preserve private job identifiers and payment uncertainty. |
...
| M6 Product/data policy | Buyer/creator journeys above accepted, private history/content access reviewed, clear pricing/refund/retention/support terms | Partial; browser paid-job checkout is a concrete missing journey |
