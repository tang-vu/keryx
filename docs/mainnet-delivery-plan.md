...
| --- | --- | --- | --- |
| B1 | Buyer discovers an offer, understands price/quality limits, funds a wallet, buys and follows a research job | `/research`, shared buyer engine, [fresh owner-operated browser funding/purchase/recovery pilot](./engineering/browser-pilot-2026-09-09.md) | Independent wallet/mobile acceptance, replaced/cancelled transactions, lost storage and fuller portable recovery. Preserve caps, private identifiers and uncertainty across those paths. |
