...
- **Circle Gateway nanopayments** — batched sub-cent settlement (floor $0.000001). Average Keryx
  payment: ~$0.0056 — a true nanopayment, uneconomical on any card rail.
...
*Arc testnet · snapshot 2026-07-03 · always current at [`/status`](https://keryx.cc/status)*

| | |
|---|---|
| On-chain nanopayments settled | **2,862** |
| Paid to creators | **$14.33** USDC → **20** wallets (100% of rewards, 0% fee) |
| Autonomous agent runs | **634** · **98.6%** reader→payer conversion |
| Entry paths | 425 payments / $2.75 via web + A2A · 2,437 / $13.20 via the volume engine |
| Creator cash-outs | self-serve gasless withdrawals executed on-chain |

Top earners: Agent Economy Weekly $3.68 · Stablecoin Ledger $3.23 · Onchain Micropayments Digest
$3.06 · Ethereum Foundation $0.47 · Stripe Blog $0.39 · Latent.Space $0.31 · CoinDesk $0.26 ·
Hugging Face $0.23 · Vitalik Buterin $0.19 · Simon Willison $0.17 · Conzit Labs $0.04 (owner-verified).
