...
*Arc testnet · snapshot 2026-07-05 · always current at [`/status`](https://keryx.cc/status)*

| | |
|---|---|
| On-chain nanopayments settled | **3,318** |
| Paid to creators | **$15.85** USDC → **20** wallets (100% of rewards, 0% fee) |
| Autonomous agent runs | **694** · **98.7%** reader→payer conversion |
| Entry paths | 429 payments / $2.78 via web + A2A · 2,889 / $14.93 via the volume engine |
| Creator cash-outs | self-serve gasless withdrawals executed on-chain |

Top earners: Agent Economy Weekly $3.88 · Stablecoin Ledger $3.48 · Onchain Micropayments Digest
$3.43 · Ethereum Foundation $0.50 · Stripe Blog $0.41 · Latent.Space $0.35 · CoinDesk $0.30 ·
Hugging Face $0.25 · Vitalik Buterin $0.22 · Simon Willison $0.20 · Conzit Labs $0.05 (owner-verified).
