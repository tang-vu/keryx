...
*Arc testnet · snapshot 2026-08-13 · always current at [`/proof`](https://keryx.cc/proof)*

| | |
|---|---|
| Settled nanopayments | **9,505** · **$44.97** total volume |
| Paid to creators | **$39.09** USDC → **20** earning creators (100% of rewards, 0% fee) |
...
| Identified retention + feedback | **4/4** actors returned · **9/9** positive responses |
| First-party agent activity | **1,701** queries · **8,894** payments · reported separately from adoption |
| Creator cash-outs | **12** self-serve gasless withdrawals (**$0.7533**) executed on-chain |
