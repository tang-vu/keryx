...
*Arc testnet · snapshot 2026-07-04 · always current at [`/status`](https://keryx.cc/status)*

| | |
|---|---|
| On-chain nanopayments settled | **3,070** |
| Paid to creators | **$15.03** USDC → **20** wallets (100% of rewards, 0% fee) |
| Autonomous agent runs | **663** · **98.6%** reader→payer conversion |
| Entry paths | 425 payments / $2.75 via web + A2A · 2,645 / $14.02 via the volume engine |
| Creator cash-outs | self-serve gasless withdrawals executed on-chain |

Top earners: Agent Economy Weekly $3.79 · Stablecoin Ledger $3.36 · Onchain Micropayments Digest
$3.21 · Ethereum Foundation $0.48 · Stripe Blog $0.40 · Latent.Space $0.33 · CoinDesk $0.28 ·
Hugging Face $0.24 · Vitalik Buterin $0.20 · Simon Willison $0.18 · Conzit Labs $0.05 (owner-verified).
